...
def save_history(response : list = [{}], model: str = "" ,progress = 0):
    ...
    history_file["messages"][-1]["model"] = model
...
def send_message_api(history: list, model: str = "", tools_send: int = 0, error_count: int = 0 ):
